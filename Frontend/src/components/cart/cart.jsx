                            ...
                            <div className="px-5 mb-3 ">
                                ...
                                <Link to="/checkout">
                                    <div className={`h-[45px] flex items-center justify-center w-[100%] bg-[#e44343] rounded-[5px]`}>
                                        <h1 className='text-[#fff] text-[18px]'>Checkout Now (USD${totalPrice})</h1>
                                    </div>
                                </Link>
                            </div>
                        </>
    ...
    return (
        <div className="border-b p-2 ">
            <div className="w-full flex items-center">
                <div>
                    <div className={`bg-[#e44343] border border-[#e4434373] rounded-full w-[25px] h-[25px] ${styles.normalFlex} justify-center cursor-pointer`} onClick={() => increament(data)}>
                ...
                <img src={`${backend_url}${data.images[0]}`} alt="image" className='w-[130px] h-min ml-2 mr-2 rounded-[5px]' />
