    ...
    return (
        <div className={`w-full block bg-white rounded-lg lg:flex p-2 shadow-sm `}>
            ...
            <div className="w-full lg:w-[50%] flex flex-col justify-center">
                ...
                <p className='text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo possimus odit voluptate autem blanditiis. Optio, eaque repudiandae maiores aperiam at sequi adipisci esse deleniti incidunt illum, vitae voluptate cupiditate accusamus!
