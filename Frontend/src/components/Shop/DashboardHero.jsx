...
function DashboardHero() {
    ...
    const totalEarningWithoutTax = deliveredOrders ? deliveredOrders.reduce((acc, item) => acc + item.totalPrice, 0) : 0;
    ...
    return (
        <div className='w-full p-8'>
            ...
            <div className="w-full block md:flex items-center justify-between">
                <div className="w-full mb-4 md:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
                    <div className="flex items-center">
                        ...
                        <h3 className={`${styles.productTitle} !text-[18px] leading-5 !font-[400] text-[#00000085]`}>Account Balance <span className='text-[16px]'>(with 10% service charge)</span></h3>
                    </div>
            ...
            <div className="w-full min-h-[40vh] shadow bg-white rounded">
                <DataGrid
                    rows={row}
                    columns={columns}
                    pageSize={10}
