...
//                         <p className="text-sm text-gray-500">Your package has been handed over to the delivery partner and is on its way. </p>

//                         <div className="mt-4">
//                             <span className="px-4 py-1 text-sm rounded-full bg-blue-100 text-blue-600"> Shipped</span>
//                         </div>
...
//                         <h1 className='text-[20px]'>Your order is coming with our delivery partner</h1>
//                     ) : (
//                         data?.status === "Received" ? (
//                             <h1 className='text-[20px]'>Your order is in your city.Our delivery partner will deliver it to you soon.</h1>
//                         ) : (
//                             data?.status === " On the way" ? (
//                                 <h1 className='text-[20px]'>Your order is on route to deliver you </h1>
//                             ) : (
